...
class Portfolio {
    ...
    async loadPortfolioData() {
        try {
            // Check if we're on Netlify (static hosting) and use static data
            if (window.location.hostname.includes('netlify.app') || window.portfolioData) {
                console.log('Using static data for Netlify deployment');
            ...
            console.log('Using sample data due to API failure:', error);
            this.loadSampleData();
        }
    }
    ...
    async handleContactSubmit(e) {
        ...
        // Check if we're on Netlify (static hosting)
        if (window.location.hostname.includes('netlify.app')) {
            // For Netlify, use Formspree or similar service
            // You need to create a Formspree account: https://formspree.io
            // Replace 'your-form-id' with your actual Formspree form ID
            const formUrl = 'https://formspree.io/f/your-form-id';
